      ...
      <div className="mx-auto max-w-7xl px-6 mt-20 lg:px-8">
        <div className="relative w-full flex justify-center">
          ...
          <div 
            ...
            className="floating-card absolute w-[343px] top-[189px] left-[0px] z-10"
          ...
          <div 
            ...
            className="floating-card absolute w-[343px] top-[325px] left-[80px] z-10"
          ...
          <div 
            ...
            className="floating-card absolute w-[273px] top-[461px] left-[48px] z-10"
          ...
          <div 
            ...
            className="floating-card absolute w-[343px] top-[312px] right-[0px] z-10"
          ...
          <div 
            ...
            className="floating-card absolute w-[343px] top-[426px] right-[80px] z-10"
