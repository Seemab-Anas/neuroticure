      ...
      <div className="relative w-full">
        ...
        <div className="relative">
          <Image 
            ...
            priority
          />
          {/* No overlay - full color image */}
        </div>
        
        {/* Footer content overlay - positioned similarly for mobile/desktop */}
        <div className="absolute bottom-6 md:bottom-6 left-0 right-0 flex justify-center z-20 py-10 md:py-0">
          <div className="w-[90%] md:w-[80%] bg-[#17181D] bg-opacity-90 rounded-3xl px-4 md:px-8 py-6">
            <div className="flex flex-col md:grid md:grid-cols-3 gap-12 md:gap-8 text-white">
              {/* Pages Column */}
              <div>
              ...
              <div>
                ...
                <div className="card">
                  <a className="socialContainer containerOne" href="https://www.instagram.com/neuroticure/" target="_blank" rel="noopener noreferrer">
                  ...
                  <a className="socialContainer containerTwo" href="https://twitter.com/neuroticure" target="_blank" rel="noopener noreferrer">
                  ...
                  <a className="socialContainer containerThree" href="https://www.linkedin.com/company/neuroticure" target="_blank" rel="noopener noreferrer">
                  ...
                  <a className="socialContainer containerFour" href="https://wa.me/923000000000" target="_blank" rel="noopener noreferrer">
                ...
                <p className="mt-5">Follow us on social media for updates and news.</p>
              </div>
              
              {/* Privacy & Copyright Column */}
              <div>
                ...
                <p className="text-sm mt-4">© {new Date().getFullYear()} Neuroticure. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
